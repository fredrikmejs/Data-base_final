...
public interface IDal {
    ...
    ProductionBatchDTO readProductionBatch(int id) throws SQLException;
    ...
    CommodityBatchDTO readCommodityBatch(int id) throws SQLException;
